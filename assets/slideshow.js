...
if (!customElements.get('slide-show')) {
  class SlideShow extends HTMLElement {
    constructor() {
      ...
      const containerWidth = slideshow.offsetWidth;
      const slideWidth = slideshow_slides[0]?.offsetWidth || 1;
      ...
      if (progress_bar) {
        ...
        const originalScrollHandler = args.on.scroll;
        ...
        args.on.scroll = function (progress) {
          ...
          if (typeof originalScrollHandler === 'function') {
            originalScrollHandler.call(this, progress);
          }
        };
      }
